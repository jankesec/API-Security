...
OWASP API Security Top 10'un amacı, bu risk analizini kuruluşunuz adına yapmak değildir. Bu sürüm veriye dayalı olarak hazırlanmadığı için zafiyetlerin yaygınlık düzeyleri, ekip üyelerinin ortak değerlendirmesi sonucunda belirlenmiştir.
